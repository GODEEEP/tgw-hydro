...
path = '/vast/projects/godeeep/VIC/mosart/'
# set a path for outputs
path_output = f'{path}/mosart_huc{huc2:02}_8th_runoff_1979_2019_kge.nc'
...
path_domain = 'input/domains/mosart_conus_nldas_grid.nc'
...
vic_output_dir = f'/vast/projects/godeeep/VIC/calibration/{huc2}/'
...
for year in range(start_year, end_year+1):
  for month in range(1, 12+1):
    ...
    ds_runoff_my.to_netcdf(os.path.join(huc2_output_dir, f'mosart_huc{huc2:02}_8th_runoff_kge_{year}_{month:02}.nc'))
